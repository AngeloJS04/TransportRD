...
import NotCard from "../../components/screens/Login/NotCard";
    ...
    return (
        <ScrollView>
            ...
            <SafeAreaView style={styles.container}>
                ...
                {cards.length === 0 && !showModalAdd && (<NotCard />)}
                                ...
                                {cards.length > 0 &&
                                    <>
                                        ...
                                        <View style={[styles.container, { marginTop: 4, marginLeft: 50, marginRight: 30 }]}>
                                            ...
                                            <Button title={"Recargar"} onPress={() => rechargeCard(item.id)} buttonStyle={{ borderRadius: 50, backgroundColor: '#3E850099' }} />
                                            ...
                                            <Text style={{ marginVertical: 10, fontSize: 11 }}>ID TARJETA :
                                                {item.id.replace(/[^\dA-Z]/g, '').replace(/(.{4})/g, '$1 ').trim()}
                                            </Text>
